...
export function EditIssueModalFile2({ data, completeUpload, removeAttachment }: { data: FileUpload, completeUpload(data: FileUpload): void, removeAttachment(id: string): void }) {
